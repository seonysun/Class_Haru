					...
					<div class="p2p_tutor_info">
						...
						<div class="short_info">
							...
							<span class="class_review"> <i class="star_img"> <img
									...
									<em class="t_nickname">{{class_detail.tutor_info_nickname}}</em>
									<span class="class_review"> <i class="star_img"> <img
											src="class/star.png" style="width: 10px; height: 10px">
								...
								<ul class="btn_area">
									<li><c:if test="${sessionScope.mvo.id==null }">
											...
											<c:if test="${jjim_count==0}">
												<a href="../images/jjim_insert.do?cno=${vo.cno }"></a>
												<img src="../class/heartoff32px.png">
											</c:if>
											<c:if test="${jjim_count!=0 }">
									...
									<li class="regi text-center"
										...
										<c:if test="${sessionScope.mvo.id==null }">
											...
											<button style="background-color: #45c5c5"
												onclick="location.href='../reserve/reserve.do?cno='+cno">클래스
												신청하기</button>
										</c:if>
									</li>
								</ul>
							...
							<td>
								<ul class="btn_area">
									...
									<li class="chat"
										...
										<c:if test="${sessionScope.mvo.id==null }">
											<button onclick="alert('로그인이 필요합니다');">
												<img src="../images/bubble32px.png">&nbsp;&nbsp;실시간 채팅
											</button>
										</c:if> <c:if test="${sessionScope.mvo.id!=null }">
